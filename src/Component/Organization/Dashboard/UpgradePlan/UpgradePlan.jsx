...
function UpgradePlan() {
  ...
  const validationSchema = yup.object().shape({
    validityInMonths: yup.string().required("Valid month is required"),
    numberOfEvents: yup.string().required("Number of events is required"),
    uploadPhotos: yup.string().required("Upload photos is required"),
