...
function InvitationCard() {
  ...
  const shareOnWhatsApp = () => {
    ...
    const slottime =
      portfolioevent.timeSlots?.[0]?.slotTime === "noon"
        ? "afternoon"
        : portfolioevent.timeSlots?.[0]?.slotTime;
    const location =  portfolioevent.timeSlots?.[0]?.description || "";
      ...
      >
        ...
        <div className="h-full flex flex-col justify-between p-8 text-center relative z-10">
          ...
          <div className="space-y-4">
            ...
            {portfolioevent?.timeSlots?.[0]?.description && (
              <div>
