...
function Footer() {
  return (
    <>
        <footer className="bg-white px-5 py-2 border-y-2 dark:border-slate-800 border-slate-200 flex flex-wrap items-center justify-between dark:bg-slate-900 bg-white">
